...
<ul>
  <li>Selection sort algorithm an array by repeatedly finding the minimum element from unsorted part and putting it at the beginning</li>
...
<ul>
  <li>src
    <ul>
      <li>selectionsort
        <ul>
          <li>SelectionSortProcess.java</li>
        </ul>
      </li>
      <li>main
        <ul>
...
<table>
  ...
  <tr>
    <td>SelectionSortProcess.java</td>
    <td>Implementing Selection Sort Process by Turkish alphabetical order</td>
  </tr>
  <tr>
    <td>Person.java</td>
